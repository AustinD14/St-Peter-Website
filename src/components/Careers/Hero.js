...
const Container = styled.div`
  ...
  background-image: url(/static/media/sammy-williams-38Un6Oi5beE-unsplash.d5e96b3e.jpg);
`;

const OpacityOverlay = tw.div`z-10 absolute inset-0 bg-orange-400 opacity-50`;
